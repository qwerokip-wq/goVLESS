/* generated from design/clients.jsx by tools/build-webapp.js — DO NOT EDIT (edit the .jsx) */
...
function ClientsList({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "cl-chip on"
  }, L.fAll), /*#__PURE__*/React.createElement("span", {
    className: "cl-chip"
  }, L.fOn), /*#__PURE__*/React.createElement("span", {
    className: "cl-chip"
  }, L.fOff), /*#__PURE__*/React.createElement("span", {
    className: "cl-chip"
  }, L.fExpired)), /*#__PURE__*/React.createElement("div", {
    className: "cl-body"
  }, /*#__PURE__*/React.createElement("div", {
    className: "cl-list"
  }, DEMO_CLIENTS.map((c, i) => /*#__PURE__*/React.createElement("div", {
    className: "cl-row",
    key: i
    ...
    className: "sub" + (c.expired ? " expired" : "")
  }, c.used, " / ", c.cap, " \xB7 ", c.expired ? lang === "ru" ? "Истёк" : "Expired" : `${lang === "ru" ? "до" : "till"} ${c.days}`), /*#__PURE__*/React.createElement("div", {
    className: `cl-mini-bar ${c.pct > 90 ? "danger" : c.pct > 75 ? "warn" : ""}`
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      width: `${Math.min(c.pct, 100)}%`
    }
  }))), c.expired ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 10,
      fontWeight: 700,
      padding: "3px 8px",
  ...
  }, lang === "ru" ? "истёк" : "exp") : !c.on ? /*#__PURE__*/React.createElement("span", {
    style: {
      width: 8,
      height: 8,
      borderRadius: "50%",
...
function ClientCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    T: T,
    title: c.name,
    sub: lang === "ru" ? "клиент · " + c.days : "client · expires " + c.days
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      overflow: "auto",
  ...
  }), L.pillProtected), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: T.ink3
    }
  }, "\xB7 ", L.online))), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 34,
      height: 34,
      borderRadius: 9,
    ...
    d: "M3 12.5V11L10 4l1.5 1.5L4.5 12.5z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M9.5 4.5L11 3l1.5 1.5L11 5"
  })))), /*#__PURE__*/React.createElement(Card, {
    title: L.cardTitleStatus
  ...
  }, vlessUrl.slice(0, 220), "\u2026", /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: 0,
      right: 0,
  ...
  }, /*#__PURE__*/React.createElement(CopyBtn, null), /*#__PURE__*/React.createElement("button", {
    className: "m-press",
    style: {
      flex: 1,
      height: 36,
    ...
    d: "M7.5 7.5h2v2M10.5 9.5v2M7.5 11.5h2"
  })), L.qr))), /*#__PURE__*/React.createElement(Card, {
    title: L.cardTitleSub
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: T.mono,
      fontSize: 11,
  ...
  }, subUrl), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      marginTop: 8
  ...
  }, L.rotate))), /*#__PURE__*/React.createElement(Card, {
    title: L.cardTitleActions
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    const palette = a.kind === "ok" ? {
      bg: T.accentSoft,
      ink: T.isDark ? T.accent2 : T.accent2,
      bd: `${T.accent}40`
    } : a.kind === "warn" ? {
      bg: T.warnSoft,
      ink: T.warn,
...
function AddClient({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ac-title"
  }, L.addTitle), /*#__PURE__*/React.createElement("div", {
    className: "ac-field"
  ...
  }, L.addName), /*#__PURE__*/React.createElement("input", {
    className: "ac-input",
    placeholder: L.addNamePh
  })), /*#__PURE__*/React.createElement("div", {
    className: "ac-row2 ac-field"
  ...
  }, L.addLimit), /*#__PURE__*/React.createElement("input", {
    className: "ac-input",
    placeholder: "100",
    inputMode: "numeric"
  }), /*#__PURE__*/React.createElement("div", {
    className: "ac-hint"
  }, L.addLimitHint)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      fontSize: 12,
      color: T.ink3,
      fontWeight: 600,
  ...
  }, L.addExpiry), /*#__PURE__*/React.createElement("input", {
    className: "ac-input",
    type: "date",
  ...
  }, L.addColor), /*#__PURE__*/React.createElement("div", {
    className: "ac-hues"
  }, hues.map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: h,
    className: "ac-hue" + (i === 1 ? " on" : ""),
    style: {
...
function QRShare({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "iPhone Anna"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: T.ink3,
      marginTop: 2
    }
  }, lang === "ru" ? "Reality · Lite" : "Reality · Lite"))), /*#__PURE__*/React.createElement("div", {
    className: "m-rise",
    style: {
      background: QRBG,
      borderRadius: 12,
      ...
      width: "fit-content",
      margin: "0 auto",
      boxShadow: T.isDark ? "0 12px 36px rgba(0,0,0,0.4)" : "0 12px 36px rgba(33,72,52,0.12)"
    }
  }, /*#__PURE__*/React.createElement("svg", {
    width: "240",
    height: "240",
    viewBox: `0 0 ${N} ${N}`
  }, cells.map((on, i) => on ? /*#__PURE__*/React.createElement("rect", {
    key: i,
    x: i % N,
    y: Math.floor(i / N),
    width: "1",
    ...
    className: "on"
  }, L.encVless), /*#__PURE__*/React.createElement("div", null, L.encSub)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      marginBottom: 10
    }
  }, /*#__PURE__*/React.createElement(DeepBtn, {
    label: L.deepV2,
    icon: /*#__PURE__*/React.createElement("svg", {
      ...
      d: "M12 12v9M12 12L3 8M12 12l9-4"
    }))
  }), /*#__PURE__*/React.createElement(DeepBtn, {
    label: L.deepStreis,
    icon: /*#__PURE__*/React.createElement("svg", {
    ...
    icon: /*#__PURE__*/React.createElement("svg", {
      ...
      d: "M5 8c1-3 4-4 7-4s6 1 7 4M5 8l-1 5 4 7h8l4-7-1-5M9 11l2 1 2-1M15 11l2 1"
    }))
  }), /*#__PURE__*/React.createElement(DeepBtn, {
    label: L.deepClip,
    icon: /*#__PURE__*/React.createElement("svg", {
    ...
    style: btnGhost(T)
  }, L.saveImg), /*#__PURE__*/React.createElement("button", {
    className: "m-press",
    style: btnPrimary(T)
  }, L.close))));
}
...
function EditField({
  ...
  }, L.editLimitTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12.5,
      color: T.ink3,
      margin: "0 0 12px"
    }
  }, L.editLimitHint), /*#__PURE__*/React.createElement("input", {
    className: "ef-input",
    defaultValue: "100",
    inputMode: "numeric"
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, L.editLimitPh), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10
    }
