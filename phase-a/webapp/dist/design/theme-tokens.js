/* generated from design/theme-tokens.jsx by tools/build-webapp.js — DO NOT EDIT (edit the .jsx) */
...
function btnPrimary(T, {
  ...
  return {
    ...
    boxShadow: T.isDark ? "0 4px 12px rgba(110,224,166,0.18)" : "0 4px 12px rgba(62,140,94,0.18)"
  };
}
function btnGhost(T) {
  return {
...
function btnDanger(T) {
  return {
    ...
    fontWeight: 600,
    cursor: "pointer",
    boxShadow: T.isDark ? "0 4px 12px rgba(232,122,122,0.18)" : "0 4px 12px rgba(179,50,47,0.18)"
  };
}
