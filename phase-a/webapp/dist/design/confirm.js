/* generated from design/confirm.jsx by tools/build-webapp.js — DO NOT EDIT (edit the .jsx) */
...
function TypedConfirmModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tc-title"
  }, title || L.typedTitle), /*#__PURE__*/React.createElement("p", {
    className: "tc-desc"
  }, description), /*#__PURE__*/React.createElement("div", {
    className: "tc-echo"
  }, echo), /*#__PURE__*/React.createElement("input", {
    className: "tc-input",
    type: "text",
    ...
    className: error ? "tc-err" : ""
  }, error ? L.mismatch : L.typedHint), /*#__PURE__*/React.createElement("span", {
    className: "tc-ttl"
  }, L.typedTtl(ttl))), /*#__PURE__*/React.createElement("div", {
    className: "tc-actions"
  }, /*#__PURE__*/React.createElement("button", {
    style: btnGhost(T)
  }, L.cancel), /*#__PURE__*/React.createElement("button", {
    className: "m-press",
    style: ready ? danger ? btnDanger(T) : btnPrimary(T) : btnPrimary(T, {
      disabled: true
    })
  }, L.confirm))));
}
...
function GenericModalDemo({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "gm-h"
  }, /*#__PURE__*/React.createElement("h3", null, isRu ? "Сбросить трафик" : "Reset traffic"), /*#__PURE__*/React.createElement("button", {
    className: "x"
  }, "\u2715")), /*#__PURE__*/React.createElement("div", {
    className: "gm-body"
  }, isRu ? "Это обнулит счётчики трафика для клиента «iPhone Anna». История сохранится в audit-log." : "This resets traffic counters for client \"iPhone Anna\". The audit log keeps a record."), /*#__PURE__*/React.createElement("div", {
    className: "gm-foot"
  }, /*#__PURE__*/React.createElement("button", {
    style: btnGhost(T)
  }, isRu ? "Отмена" : "Cancel"), /*#__PURE__*/React.createElement("button", {
    className: "m-press",
    style: btnPrimary(T)
  }, isRu ? "Сбросить" : "Reset"))));
}
...
function ActionSheetDemo({
    ...
    switch (name) {
      case "power":
        return /*#__PURE__*/React.createElement("svg", props, /*#__PURE__*/React.createElement("path", {
          ...
          d: "M5.5 5.5a5 5 0 1 0 7 0"
        }));
      case "edit":
        return /*#__PURE__*/React.createElement("svg", props, /*#__PURE__*/React.createElement("path", {
          d: "M3 14.5V13L12 4l1.5 1.5L4.5 14.5z"
        }), /*#__PURE__*/React.createElement("path", {
          d: "M11.5 4.5L13 3l1.5 1.5L13 6"
        }));
      case "clock":
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "as-title"
  }, isRu ? "iPhone Anna · действия" : "iPhone Anna · actions"), actions.map((a, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: `as-row ${a.kind !== "default" ? a.kind : ""}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "ic"
  }, ic(a.icon)), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }, a.label), /*#__PURE__*/React.createElement("svg", {
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
    fill: "none",
