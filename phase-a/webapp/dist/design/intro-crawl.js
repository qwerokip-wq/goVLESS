/* generated from design/intro-crawl.jsx by tools/build-webapp.js — DO NOT EDIT (edit the .jsx) */
...
const INTRO_COPY = {
  ru: {
    ...
    episode: "УСТАНОВКА I",
    title: "goVLESS",
    paragraphs: ["Это не сервис. Это инструмент, который поднимает VLESS-туннель на вашем собственном сервере. Никто между вами и сетью.", "Вы платите своему хостеру, а не нам. Соблюдайте законы своей страны. Не используйте туннель во вред — ни себе, ни другим.", "Дальше вы выберете сервер, добавите первого клиента и получите ссылку для подключения. Это занимает примерно три минуты."],
  ...
  en: {
    ...
    title: "goVLESS",
    paragraphs: ["This is not a service. It is a tool that raises a VLESS tunnel on your own server. Nobody sits between you and the open internet.", "You pay your host, not us. Respect your local laws. Do not use the tunnel to harm yourself or anyone else.", "Next you will pick a server, add a first client, and get a connect link. The whole thing takes about three minutes."],
...
function IntroCrawl({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "layer-1"
  }, STAR_FIELD.filter((_, i) => i % 3 === 0).map((s, i) => /*#__PURE__*/React.createElement("circle", {
    key: "a" + i,
    cx: s.x,
    cy: s.y,
    r: s.r * 0.6,
    ...
    className: "layer-2"
  }, STAR_FIELD.filter((_, i) => i % 3 === 1).map((s, i) => /*#__PURE__*/React.createElement("circle", {
    key: "b" + i,
    cx: s.x,
    cy: s.y,
    r: s.r * 0.9,
    ...
    className: "layer-3"
  }, STAR_FIELD.filter((_, i) => i % 3 === 2).map((s, i) => /*#__PURE__*/React.createElement("circle", {
    key: "c" + i,
    cx: s.x,
    cy: s.y,
    r: s.r * 1.3,
    ...
    className: "skip"
  }, T.skip, " \u2192")), /*#__PURE__*/React.createElement("div", {
    className: "above"
  }, T.above), /*#__PURE__*/React.createElement("div", {
    className: "stage"
  }, /*#__PURE__*/React.createElement("div", {
    className: "crawl"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ep"
  }, T.episode), /*#__PURE__*/React.createElement("h1", {
    className: "title"
  }, T.title), T.paragraphs.map((p, i) => /*#__PURE__*/React.createElement("p", {
    key: i
  }, p)))), /*#__PURE__*/React.createElement("div", {
    className: "footer-hint"
  }, lang === "ru" ? "выберите путь" : "choose your path"), /*#__PURE__*/React.createElement("div", {
    className: "bottom"
  }, /*#__PURE__*/React.createElement("button", {
    className: "cta primary"
  }, T.needServer, /*#__PURE__*/React.createElement("small", null, T.needServerSub)), /*#__PURE__*/React.createElement("button", {
    className: "cta"
  }, T.haveServer, /*#__PURE__*/React.createElement("small", null, T.haveServerSub))));
}
