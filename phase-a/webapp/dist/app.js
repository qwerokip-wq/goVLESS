/* generated from app.jsx by tools/build-webapp.js — DO NOT EDIT (edit the .jsx) */
...
async function rpc(method, params) {
  ...
  try {
    ...
    if (j.error) {
      ...
      e.code = j.error.code;
      e.detail = j.error.data;
      throw e;
    }
    return j.result;
  } catch (e) {
    if (e && (e.name === "AbortError" || e.code === 20)) {
      const te = new Error(STR[TG_LANG] && STR[TG_LANG].server_down || "Server is not responding");
      te.code = 504;
      throw te;
    }
    throw e;
...
const STR = {
  ru: {
    ...
    theme_sys_lc: "системную",
    theme_light_lc: "светлую",
    theme_dark_lc: "тёмную",
    theme_prefix: "Тема: ",
    repair_sub: "Восстановить сервер подписок",
    repair_links: "Перегенерировать ссылки и QR клиентов",
    no_inbounds: "Inbound'ов нет.",
  ...
  en: {
    ...
    vpn_off: "VPN off",
    qr_unavail: "QR unavailable",
    restore_btn: "Restore",
    rotate_creds_btn: "Rotate credentials",
    inbound_not_found: "Inbound not found",
    time_locale: "en-US",
    repair_warn: "Running repair…",
    tunnel_changed: "Tunnel changed",
    cf_new_addr: "New Cloudflare address",
    lite_pro_done: "Lite/Pro switch complete",
    daemons_restarted: "Daemons restarted",
    qr: "QR",
    vless: "VLESS link",
    subscr: "Subscription URL",
    uuid_label: "UUID",
    ...
    disc_h1: "01 · Purpose of the materials",
    disc_h2: "02 · Legality and responsibility",
    disc_h3: "03 · Strictly prohibited",
    disc_h4: "04 · What to keep in mind",
    ...
    theme_sys_lc: "system",
    theme_light_lc: "light",
    theme_dark_lc: "dark",
    theme_prefix: "Theme: ",
    repair_sub: "Restore the subscription server",
    repair_links: "Regenerate client links & QR",
    all_n: "All",
    count_active: "active",
    files_count: "files",
    expiry_until: "until",
...
function useTheme() {
  ...
  const [pref, setPref] = useState(() => {
    try {
      return localStorage.getItem(lsKey) || "system";
    } catch (e) {
      return "system";
    }
  });
...
function ModalHost() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    onClick: e => {
      if (e.target === e.currentTarget) setNode(null);
    },
    style: {
      position: "fixed",
      inset: 0,
...
function Header({
  ...
  }, onBack ? /*#__PURE__*/React.createElement("svg", {
    width: "18",
    height: "18",
    viewBox: "0 0 18 18",
    fill: "none",
  ...
  }, themePref === "light" ? "☀" : themePref === "dark" ? "☾" : "◐"), /*#__PURE__*/React.createElement("button", {
    onClick: onSettings || (() => {
...
function Avatar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      background: `oklch(0.58 0.10 ${hue || 145})`,
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
      color: "#fff",
...
function TypedConfirm({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u26A0\uFE0F ", L.confirm_title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: T.ink2,
      margin: "6px 0",
  ...
  }, L.confirm_type, " ", /*#__PURE__*/React.createElement("code", {
    style: {
      fontFamily: T.mono,
      background: T.card2,
      padding: "2px 6px",
    ...
    style: {
      marginLeft: 6,
      fontFamily: T.mono,
      color: ttl < 10 ? T.danger : T.ink3
    }
  }, ttl, "s")), /*#__PURE__*/React.createElement("input", {
    value: val,
...
function typedConfirm(T, L, expected, description) {
  return new Promise(res => openModal(/*#__PURE__*/React.createElement(TypedConfirm, {
    T: T,
    L: L,
    expected: expected,
...
function HomeScreen({
  ...
  useEffect(() => {
    (async () => {
      ...
      let firstErr = null;
      try {
        s = await rpc("system.status", {});
      } catch (e) {
        if (!firstErr) firstErr = e;
      }
      try {
        c = await rpc("client.list", {});
      } catch (e) {
        if (!firstErr) firstErr = e;
      }
      try {
        a = await rpc("audit.tail", {
          limit: 5
        });
  ...
  if (data.err) return /*#__PURE__*/React.createElement(ErrorPane, {
    T: T,
    L: L,
    error: data.err,
    themePref: themePref,
  ...
  if (!data.loaded) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    themePref: themePref,
    onThemeClick: onThemeClick
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    T: T,
    L: L,
    title: L.appName || "goVLESS",
    sub: `${s.mode || "lite"} · ${s.transport || "reality"}`,
    themePref: themePref,
    onThemeClick: onThemeClick
  }), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      ...
      padding: "20px 18px",
      boxShadow: T.shadow,
      border: T.isDark ? `1px solid ${T.border}` : "none"
    }
  }, /*#__PURE__*/React.createElement(Pill, {
    T: T,
    kind: isOn ? "ok" : "warn"
  }, isOn ? L.shield_on : L.vpn_off), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 22,
      fontWeight: 700,
      margin: "12px 0 6px",
  ...
  }, isOn ? L.state_on : L.state_off), "."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12.5,
      color: T.ink3
    }
  }, s.mode === "lite" ? L.cf_tunnel : L.nginx_le, " \xB7 ", active, " ", L.clients_count), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 18,
      marginTop: 18,
      paddingTop: 16,
      borderTop: `1px solid ${T.isDark ? T.hair : "#e6efea"}`
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
  ...
  }, active, " / ", cs.length), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: T.ink3,
      marginTop: 2
    }
  }, L.clients_online)), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    d: "M12 5v14M5 12h14"
  })), L.add), /*#__PURE__*/React.createElement("button", {
    ...
    d: "M10.85 12.15L19 4M15 8l3 3M14 9l3 3"
  })), L.keys_tile)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, L.clients), /*#__PURE__*/React.createElement("a", {
    onClick: () => navigate("#/clients"),
    style: {
      fontSize: 13,
      color: T.accent2,
  ...
  }, L.all_n, " (", cs.length, ")")), cs.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      color: T.ink3,
      padding: "32px 12px",
  ...
  }, cs.slice(0, 5).map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: c.uuid,
  ...
  }, formatBytes(c.traffic_used), " \xB7 ", c.expiry_ts ? L.expiry_until + " " + formatTs(c.expiry_ts) : "∞")), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 8,
      height: 8,
      borderRadius: "50%",
  ...
  }, L.menu), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 10
    }
  }, [["Inbounds", "#/inbounds"], [L.system, "#/system"], [L.panel_access, "#/panel"], [L.repair, "#/repair"], [L.backups, "#/backup"], [L.notifications, "#/notifications"], [L.admins, "#/admins"], [L.settings, "#/settings"], [L.about, "#/about"], [L.disclaimer, "#/disclaimer"]].map(([label, h]) => /*#__PURE__*/React.createElement("button", {
    key: h,
    onClick: () => navigate(h),
    style: {
      display: "flex",
...
function ClientsListScreen({
  ...
  useEffect(() => {
    rpc("client.list", {}).then(setCs).catch(e => {
      toast(L.err + e.message, "err");
      setCs([]);
    });
  }, []);
  useEffect(() => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    L: L,
    title: L.clients,
    sub: cs ? `${cs.length} ${L.count_active}` : "",
    onBack: () => navigate("#/"),
    themePref: themePref,
    onThemeClick: onThemeClick
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }), cs === null ? /*#__PURE__*/React.createElement(ClientsSkeleton, {
    T: T
  }) : f.length === 0 ? cs.length === 0 ? /*#__PURE__*/React.createElement(EmptyState, {
    T: T,
    icon: "\uD83D\uDC65",
    title: L.empty,
    sub: L.empty_hint,
    actionLabel: L.add,
    onAction: () => openAddClient(T, L, navigate)
  }) : /*#__PURE__*/React.createElement(EmptyState, {
    T: T,
    icon: "\uD83D\uDD0D",
    title: L.no_results,
    sub: `${L.search_no_match.replace("{q}", filter)}`
  }) : /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      borderRadius: 22,
  ...
  }, f.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: c.uuid,
    onClick: () => navigate("#/clients/" + c.uuid),
    style: {
      display: "flex",
    ...
    onClick: () => openAddClient(T, L, navigate),
    style: {
      position: "fixed",
      ...
      fontWeight: 600,
      cursor: "pointer",
      boxShadow: T.isDark ? "0 8px 24px rgba(110,224,166,0.20)" : "0 8px 24px rgba(62,140,94,0.25)",
      zIndex: 50
    }
  }, L.add));
}
...
function ClientCardScreen({
  ...
  const onShowQR = async preferSub => {
    haptic();
    try {
      const r = await rpc("client.qr", {
        uuid,
        prefer_subscription: preferSub
      });
      const showSubCopy = r.kind !== "subscription" && r.sub_url;
      openModal(/*#__PURE__*/React.createElement(QRModal, {
        T: T,
        L: L,
        qr: r,
        onCopyLink: () => onCopy(r.link),
        onCopySub: showSubCopy ? () => onCopy(r.sub_url) : null
      }));
    } catch (e) {
      toast(L.err + e.message, "err");
    }
    ...
    try {
      ...
      try {
        await rpc(method, {
          ...
          confirm_token: e.detail.confirm_token
        });
        onOk();
      } catch (ee) {
        toast(L.err + ee.message, "err");
      }
    }
  };
  const onToggle = async () => {
    ...
    try {
      ...
      toast(cl.enabled ? L.disabled : L.enabled, "ok");
      reload();
    } catch (e) {
      if (e.code === 412 && e.detail && e.detail.confirm) {
  ...
  if (err) return /*#__PURE__*/React.createElement(ErrorPane, {
    T: T,
    L: L,
    error: err,
  ...
  if (!cl) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/clients"),
    themePref: themePref,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, card(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 14,
    ...
    T: T,
    kind: cl.enabled ? "ok" : "warn"
  }, cl.enabled ? L.is_on : L.is_off, cl.online ? " · online" : "")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, L.traffic), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink,
      fontFamily: T.mono,
      fontSize: 12
    }
  }, formatBytes(cl.traffic_used), " ", cl.traffic_limit ? "/ " + formatBytes(cl.traffic_limit) : "/ ∞"), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3
    }
  }, L.expires), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink,
      fontFamily: T.mono,
      fontSize: 12
    }
  }, cl.expiry_ts ? formatTs(cl.expiry_ts) : L.never), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3
    }
  }, L.uuid_label), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink,
      fontFamily: T.mono,
      fontSize: 11,
  ...
  }, cl.uuid)))), cl.sub_url && card(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 14,
      margin: "0 0 8px",
      color: T.ink
    }
  }, L.subscr), /*#__PURE__*/React.createElement("div", {
    onClick: () => onCopy(cl.sub_url),
    style: linkBlock(T)
  }, cl.sub_url), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      marginTop: 8
  ...
  }, L.copy), /*#__PURE__*/React.createElement("button", {
    onClick: () => onShowQR(true),
    style: btn(T, "secondary")
  }, L.qr), /*#__PURE__*/React.createElement("button", {
    onClick: onRotateSub,
    style: btn(T, "warn")
  }, L.rotate)))), cl.link && card(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 14,
      margin: "0 0 8px",
      color: T.ink
    }
  }, L.vless), /*#__PURE__*/React.createElement("div", {
    onClick: () => onCopy(cl.link),
    style: linkBlock(T)
  }, cl.link), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      marginTop: 8
    ...
    onClick: () => onShowQR(false),
    style: btn(T, "secondary")
  }, L.qr)))), card(/*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 14,
      margin: "0 0 10px",
      color: T.ink
    }
  }, L.actions), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 8
    ...
    onClick: onToggle,
    style: btn(T, cl.enabled ? "warn" : "ok")
  }, cl.enabled ? L.btn_disable : L.btn_enable), /*#__PURE__*/React.createElement("button", {
    onClick: () => openModal(/*#__PURE__*/React.createElement(EditFieldModal, {
      T: T,
      L: L,
      kind: "limit",
      client: cl,
    ...
    style: btn(T, "secondary")
  }, L.btn_limit), /*#__PURE__*/React.createElement("button", {
    onClick: () => openModal(/*#__PURE__*/React.createElement(EditFieldModal, {
      T: T,
      L: L,
      kind: "expiry",
    ...
    style: btn(T, "secondary")
  }, L.btn_expiry), /*#__PURE__*/React.createElement("button", {
    onClick: onReset,
    style: btn(T, "warn")
  }, L.btn_reset), /*#__PURE__*/React.createElement("button", {
    onClick: () => openModal(/*#__PURE__*/React.createElement(EditFieldModal, {
      T: T,
      L: L,
      kind: "name",
    ...
    style: btn(T, "secondary")
  }, L.btn_rename), /*#__PURE__*/React.createElement("button", {
    onClick: onDelete,
    style: btn(T, "danger")
  }, L.btn_delete))))));
}
function QRModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, qr.kind === "subscription" ? L.qr_sub : L.qr_vless), qr.qr_svg ? /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, qr.qr_text || L.qr_unavail), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      marginTop: 14
    ...
    onClick: onCopyLink,
    style: btn(T, "secondary")
  }, qr.kind === "subscription" ? L.copy_sub : L.copy_key), qr.kind !== "subscription" && onCopySub && /*#__PURE__*/React.createElement("button", {
    onClick: onCopySub,
    style: btn(T, "secondary")
  }, L.copy_sub), /*#__PURE__*/React.createElement("button", {
    onClick: closeModal,
    style: {
      ...btn(T, "secondary"),
      flex: "0 0 auto",
...
function DesignFrame({
  ...
  }, Comp ? /*#__PURE__*/React.createElement(Comp, _extends({
    theme: T.id,
    lang: lang
  }, extraProps || {})) : /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 24,
      textAlign: "center",
      color: T.ink3
  ...
  }, "\uD83D\uDEA7"), /*#__PURE__*/React.createElement("div", null, "\u042D\u043A\u0440\u0430\u043D \xAB", name, "\xBB \u0432 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0435"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      marginTop: 6
    }
  }, "\u0414\u0438\u0437\u0430\u0439\u043D \u0433\u043E\u0442\u043E\u0432 \u0432 /design/, RPC-wiring \u0437\u0430\u043F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D \u0432 Batch 3."))));
}
function LoadingPane({
  ...
  const spinner = /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      height: 28,
      borderRadius: "50%",
      border: `3px solid ${T.bgSoft}`,
      borderTopColor: T.accent,
      animation: "spin 800ms linear infinite"
    }
  });
  if (embedded) return /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "center",
      padding: 40
  ...
  }, (onBack !== undefined || themePref) && /*#__PURE__*/React.createElement(Header, {
    T: T,
    L: L,
    title: "goVLESS",
    onBack: onBack,
...
function ErrorPane({
  ...
  }, is401 ? "🔒" : "⚠"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 15,
      fontWeight: 600,
      color: T.ink,
  ...
  }, is401 ? L.rpc_unavailable : L.err.trim()), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: T.ink3,
      lineHeight: 1.45,
...
function SettingsScreen({
  ...
  const radio = (val, currentVal, onPick, labelText, sub) => /*#__PURE__*/React.createElement("button", {
    onClick: () => onPick(val),
    style: {
      display: "flex",
      alignItems: "center",
  ...
  }, currentVal === val && /*#__PURE__*/React.createElement("svg", {
    width: "11",
    height: "11",
    viewBox: "0 0 12 12",
    fill: "none",
  ...
  }, labelText), sub && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: T.ink3,
      marginTop: 2
  ...
  }, L.lang_section), /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
  ...
  }, radio("ru", lang, setLang, L.lang_ru, "RU"), radio("en", lang, setLang, "English", "EN")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: T.ink3,
      padding: "6px 4px 0"
    }
  }, L.apply_hint)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: "0 4px 8px",
      fontSize: 11,
      fontWeight: 600,
  ...
  }, L.theme_label), /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
  ...
  }, radio("system", pref, setPref, L.theme_system, L.theme_sys_hint), radio("light", pref, setPref, L.theme_light, "L5 Pastel Mint"), radio("dark", pref, setPref, L.theme_dark, "D2 Midnight Slate")))), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: "0 0 auto",
...
function SystemScreenReal({
  ...
  const load = async () => {
    let firstErr = null;
    try {
      setStatus(await rpc("system.status", {}));
    } catch (e) {
      firstErr = e;
    }
    try {
      setTunnel(await rpc("tunnel.url_get", {}));
    } catch (e) {}
    try {
      setAudit(await rpc("audit.tail", {
        limit: 10
      }));
    } catch (e) {}
  ...
  if (!loaded) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/"),
    themePref: themePref,
  ...
  const dot = on => /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-block",
      width: 8,
      height: 8,
      borderRadius: "50%",
      background: on ? T.accent : T.danger,
      boxShadow: on ? `0 0 6px ${T.accent}` : "none",
      marginRight: 6
    }
  });
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, L.services), row(/*#__PURE__*/React.createElement(React.Fragment, null, dot(s.xui_active), "x-ui"), s.xui_active ? "active" : "inactive"), row(/*#__PURE__*/React.createElement(React.Fragment, null, dot(s.xray_active), "xray"), s.xray_active ? "active" : "inactive"), row(/*#__PURE__*/React.createElement(React.Fragment, null, dot(s.nginx_active), "nginx"), s.nginx_active ? "active" : s.mode === "lite" ? "inactive (Lite)" : "inactive"), row(L.mode, s.mode || "—"), row(L.transport, s.transport || "—")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
  ...
  }, L.version), row("goVLESS", "v" + (s.version || "—")), row("3X-UI / Xray", (s.xui_version || "—") + " / " + (s.xray_version || "—"))), tunnel && /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
    ...
    T: T,
    kind: tunnel.url ? "ok" : "warn"
  }, tunnel.source === "pro" ? "Pro · nginx" : tunnel.source === "quick" ? "Lite · Cloudflare Quick" : tunnel.source === "named" ? "Lite · Named" : L.not_active)), tunnel.url && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: T.ink3,
      fontFamily: T.mono
    }
  }, "fp: sha256:", window.btoa ? btoa(tunnel.url).slice(0, 12) : tunnel.url.slice(-12))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
    ...
    style: btn(T, "secondary")
  }, "\u21BB ", L.repair), /*#__PURE__*/React.createElement("button", {
    onClick: async () => {
      try {
        await rpc("system.restart", {});
        toast(L.restart_2s, "ok");
        setTimeout(() => {
    ...
    style: btn(T, "warn")
  }, "\u27F2 Restart all"))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
  ...
  }, L.recent_actions), audit.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3,
      fontSize: 13,
      padding: "8px 0"
    }
  }, L.audit_empty) : audit.map((e, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: "flex",
      gap: 10,
  ...
  }, formatTs(e.ts) || "—"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: T.accent2,
      flex: 1
    }
...
function AdminsScreenReal({
  ...
  const [reloadKey, setReloadKey] = useState(0);
  useEffect(() => {
    rpc("admin.list", {}).then(setIds).catch(e => {
      if (e.code === 401) setErr(e);else {
        setIds([]);
        toast(L.err + e.message, "err");
      }
    });
  ...
  const onInvite = async () => {
    const tgid = val.trim();
    if (!/^\d{4,12}$/.test(tgid)) {
      toast(L.bad_tg_id, "err");
      return;
    }
    setBusy(true);
    try {
      await rpc("admin.invite", {
        tg_id: tgid
      });
      toast(L.invited, "ok");
      setVal("");
  ...
  if (!ids) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/"),
    themePref: themePref,
  ...
  }, L.current_admins), ids.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3,
      fontSize: 13,
      padding: "12px 0",
  ...
  }, L.nobody) : /*#__PURE__*/React.createElement("ul", {
    style: {
      listStyle: "none",
      padding: 0,
      margin: 0,
  ...
  }, ids.map((id, i) => /*#__PURE__*/React.createElement("li", {
    key: id,
    style: {
      padding: "8px 0",
      borderBottom: i < ids.length - 1 ? `1px solid ${T.hair}` : "none",
      color: T.ink
    }
  ...
  }, L.invite), /*#__PURE__*/React.createElement("input", {
    value: val,
    onChange: e => setVal(e.target.value),
  ...
  }, busy ? L.inviting : L.invite), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: T.ink3,
      padding: "8px 4px 0"
...
function InboundsScreenReal({
  ...
  const [reloadKey, setReloadKey] = useState(0);
  useEffect(() => {
    rpc("inbound.list", {}).then(setList).catch(e => {
      if (e.code === 401) setErr(e);else {
        setList([]);
        toast(L.err + e.message, "err");
      }
  ...
  if (!list) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/"),
    themePref: themePref,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    L: L,
    title: "Inbounds",
    sub: `${list.length} ${L.count_active}`,
    onBack: () => navigate("#/"),
    themePref: themePref,
    onThemeClick: onThemeClick
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, L.no_inbounds) : list.map(ib => /*#__PURE__*/React.createElement("div", {
    key: ib.id,
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
  ...
  }, ib.remark || "Inbound #" + ib.id), /*#__PURE__*/React.createElement(Pill, {
    T: T,
    kind: ib.enable ? "ok" : "warn"
  }, ib.enable ? L.is_on : L.is_off)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "max-content 1fr",
      gap: "6px 14px",
  ...
  }, L.port), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink,
      fontFamily: T.mono,
      fontSize: 12,
  ...
  }, ib.port), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3
    }
  }, L.protocol), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink,
      textAlign: "right"
    }
  }, ib.protocol), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3
    }
  ...
  }, ib.network || "—"), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3
    }
  ...
  }, ib.security || "—"), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink3
    }
  }, L.clients), /*#__PURE__*/React.createElement("div", {
    style: {
      color: T.ink,
      textAlign: "right"
    }
  }, ib.client_count)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8
    }
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => navigate("#/inbounds/" + ib.id),
    style: {
      ...btn(T, "secondary"),
      flex: 1
    }
  }, L.more), /*#__PURE__*/React.createElement("button", {
    onClick: () => onToggle(ib),
    style: {
      ...btn(T, ib.enable ? "warn" : "ok"),
      flex: 1
    }
...
function BackupScreenReal({
  ...
  const [reloadKey, setReloadKey] = useState(0);
  useEffect(() => {
    rpc("backup.list", {}).then(r => setList(r.backups || [])).catch(e => {
      if (e.code === 401) setErr(e);else {
        setList([]);
        toast(L.err + e.message, "err");
      }
  ...
  const onRestore = async bk => {
    try {
      ...
      if (e.code === 412 && e.detail && e.detail.confirm) {
        ...
        try {
          const r = await rpc("backup.restore", {
            path: bk.path,
            confirm: e.detail.confirm,
            confirm_token: e.detail.confirm_token
          });
          ...
          setTimeout(() => {
            if (confirm(L.backup_done_q)) window.location.reload();
          }, 800);
        } catch (ee) {
          toast(L.err + ee.message, "err");
        }
  ...
  if (list === null) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/"),
    themePref: themePref,
  ...
  }, busy ? L.creating_backup : L.btn_create_backup), list.length === 0 ? /*#__PURE__*/React.createElement(EmptyState, {
    T: T,
    icon: "\uD83D\uDCE6",
    title: L.no_backups,
  ...
  }, list.map((bk, i) => /*#__PURE__*/React.createElement("div", {
    key: bk.path,
    style: {
      padding: "12px 14px",
      borderTop: i > 0 ? `1px solid ${T.hair}` : "none"
  ...
  }, bk.name), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: T.ink3,
      fontFamily: T.mono
    }
  }, formatBytes(bk.size))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: T.ink3,
      fontFamily: T.mono,
  ...
  }, new Date(bk.ts * 1000).toLocaleString(L.time_locale)), /*#__PURE__*/React.createElement("button", {
    onClick: () => onRestore(bk),
    style: {
      ...btn(T, "warn"),
      width: "100%",
      fontSize: 13
...
function RepairScreen({
  ...
  const onRun = async () => {
    ...
    try {
      ...
      setLastResult(r);
      if (r.ok) toast(L.restore_done, "ok");else toast(L.repair_warn, "warn");
    } catch (e) {
      toast(L.err + e.message, "err");
    }
    setBusy(false);
  ...
  }, L.what_will_happen), /*#__PURE__*/React.createElement("ul", {
    style: {
      margin: "0 0 12px",
      paddingLeft: 20,
      color: T.ink2,
  ...
  }, /*#__PURE__*/React.createElement("li", null, L.repair_ip), /*#__PURE__*/React.createElement("li", null, L.repair_sub), /*#__PURE__*/React.createElement("li", null, L.repair_links)), /*#__PURE__*/React.createElement("button", {
    onClick: onRun,
    disabled: busy,
    style: {
      ...btn(T, "ok"),
  ...
  }, busy ? L.restoring : L.btn_run)), lastResult && /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card2,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
  ...
  }, L.result), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 8
    }
  }, /*#__PURE__*/React.createElement(Pill, {
    T: T,
    kind: lastResult.ok ? "ok" : "warn"
  }, lastResult.ok ? L.success : L.with_warnings)), lastResult.stdout && /*#__PURE__*/React.createElement("pre", {
    style: {
      fontFamily: T.mono,
      fontSize: 10,
      color: T.ink2,
  ...
  }, lastResult.stdout), lastResult.stderr && /*#__PURE__*/React.createElement("pre", {
    style: {
      fontFamily: T.mono,
      fontSize: 10,
      color: T.danger,
...
function AboutScreenReal({
  ...
  useEffect(() => {
    rpc("system.status", {}).then(setS).catch(() => setS({
      version: "—"
    }));
  }, []);
  const row = (k, v) => /*#__PURE__*/React.createElement("div", {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "gV"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 700,
      color: T.ink
  ...
  }, row(L.build, "goVLESS v" + (s?.version || "—")), row("3X-UI / Xray", (s?.xui_version || "—") + " / " + (s?.xray_version || "—")), row(L.license, "GPL-3.0"), row(L.mode, s?.mode || "—")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
    ...
    href: "https://github.com/anten-ka/goVLESS",
    target: "_blank",
    rel: "noopener",
    onClick: e => {
      if (TG && TG.openLink) {
        e.preventDefault();
        TG.openLink("https://github.com/anten-ka/goVLESS");
      }
    },
    style: {
      display: "flex",
  ...
  }, L.src_github), /*#__PURE__*/React.createElement("span", {
    style: {
      color: T.ink3
    }
  }, "\u2192")), /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, L.read_disc), /*#__PURE__*/React.createElement("span", {
    style: {
      color: T.ink3
    }
  }, "\u2192")), /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, L.settings), /*#__PURE__*/React.createElement("span", {
    style: {
      color: T.ink3
    }
  }, "\u2192")))));
...
function DisclaimerScreenReal({
  ...
  }, L.legal_warn), L.decline_close), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 15,
      fontWeight: 700,
      color: T.ink,
  ...
  }, L.disc_h1), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 10px"
    }
  }, L.disc_p1), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 15,
      fontWeight: 700,
      color: T.ink,
  ...
  }, L.disc_h2), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 10px"
    }
  }, L.disc_p2), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 15,
      fontWeight: 700,
      color: T.danger,
  ...
  }, L.disc_h3), /*#__PURE__*/React.createElement("ul", {
    style: {
      margin: "0 0 10px",
      paddingLeft: 18
    }
  }, /*#__PURE__*/React.createElement("li", null, L.disc_dont_1), /*#__PURE__*/React.createElement("li", null, L.disc_dont_2), /*#__PURE__*/React.createElement("li", null, L.disc_dont_3)), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 15,
      fontWeight: 700,
      color: T.ink,
  ...
  }, L.disc_h4), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "0 0 10px"
    }
  }, L.disc_p3), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: T.mono,
      fontSize: 11,
      color: T.ink3,
  ...
  }, "as is \xB7 GPL-3.0 \xB7 2025-11")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: "0 0 auto",
  ...
  }, L.already_acc) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    onClick: () => navigate("#/"),
    style: {
      ...btn(T, "secondary"),
      flex: "0 0 auto",
  ...
  }, L.btn_decline), /*#__PURE__*/React.createElement("button", {
    onClick: onAccept,
    style: {
      ...btn(T, "ok"),
      flex: 1
...
function AddClientSheet({
  ...
  const submit = async () => {
    const nm = name.trim();
    if (!nm || !/^[A-Za-z0-9_.\-]{1,32}$/.test(nm)) {
      toast(L.name_rules32, "err");
      return;
    }
    setBusy(true);
    try {
  ...
  }, L.new_client), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "block",
      fontSize: 12,
      color: T.ink3,
  ...
  }, L.limit_gb), /*#__PURE__*/React.createElement("input", {
    value: limitGB,
  ...
  }, L.expiry_opt), /*#__PURE__*/React.createElement("input", {
    value: expiry,
...
function openAddClient(T, L, navigate) {
  haptic();
  openModal(/*#__PURE__*/React.createElement(AddClientSheet, {
    T: T,
    L: L,
    onDone: uuid => {
      if (uuid) navigate("#/clients/" + uuid);else navigate("#/clients");
    }
  }));
}
...
function EditFieldModal({
  ...
  const submit = async () => {
    ...
    try {
      const fields = {};
      if (kind === "name") {
        if (!val.trim() || !/^[A-Za-z0-9_.\-]{1,32}$/.test(val.trim())) {
          toast(L.name_rules, "err");
          setBusy(false);
          return;
        }
        ...
        try {
          await rpc("client.update", {
            ...
            fields: kind === "name" ? {
              ...
              traffic_limit: val ? Math.floor(parseFloat(val) * 1024 * 1024 * 1024) : 0
            } : {
              expiry_ts: val ? Math.floor(new Date(val).getTime() / 1000) : 0
            },
            confirm: e.detail.confirm,
            confirm_token: e.detail.confirm_token
          });
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, kind === "name" ? L.btn_rename : kind === "limit" ? L.btn_limit : L.expiry, " \xB7 ", client.name), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "block",
      fontSize: 12,
      color: T.ink3,
    ...
    style: {
      ...
      padding: "10px 12px",
      borderRadius: 8,
      fontFamily: inputType === "number" || inputType === "date" ? T.font : T.mono,
      fontSize: 13,
      minHeight: 44
    }
  }), /*#__PURE__*/React.createElement("div", {
...
function InboundDetailScreen({
  ...
  useEffect(() => {
    rpc("inbound.list", {}).then(list => {
      const found = list.find(x => String(x.id) === String(id));
      if (!found) setErr(new Error(L.inbound_not_found));else setIb(found);
    }).catch(setErr);
  }, [id]);
  if (err) return /*#__PURE__*/React.createElement(ErrorPane, {
    T: T,
    L: L,
    error: err,
    onBack: () => navigate("#/inbounds"),
    themePref: themePref,
    onThemeClick: onThemeClick
  });
  if (!ib) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/inbounds"),
    themePref: themePref,
  ...
  }, L.params), /*#__PURE__*/React.createElement(Pill, {
    T: T,
    kind: ib.enable ? "ok" : "warn"
  }, ib.enable ? L.is_on : L.is_off)), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, ib.client_count))), reality && /*#__PURE__*/React.createElement("div", {
    style: {
      background: T.card,
      border: `1px solid ${T.border}`,
      borderRadius: 14,
  ...
  }, "Reality keys"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      marginBottom: 4
    }
  }, "Public key"), /*#__PURE__*/React.createElement("div", {
    onClick: () => {
      navigator.clipboard.writeText(reality.publicKey || "").then(() => toast(L.copied, "ok"));
    },
    style: linkBlock(T)
  }, reality.publicKey || "—"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      margin: "12px 0 4px",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Private key"), /*#__PURE__*/React.createElement("button", {
  ...
  }, showPrivate ? L.hide : L.show)), /*#__PURE__*/React.createElement("div", {
    onClick: () => {
      if (showPrivate) navigator.clipboard.writeText(reality.privateKey || "").then(() => toast(L.copied, "ok"));
    },
    style: {
      ...linkBlock(T),
      filter: showPrivate ? "none" : "blur(5px)",
      cursor: showPrivate ? "copy" : "default"
    }
  }, reality.privateKey || "—"), reality.shortIds && reality.shortIds.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      margin: "12px 0 4px"
    }
  }, "Short IDs"), reality.shortIds.map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      ...linkBlock(T),
      margin: "4px 0"
    }
  }, s || "(empty)"))), reality.dest && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      margin: "12px 0 4px"
    }
  }, L.mask_domain), /*#__PURE__*/React.createElement("div", {
    style: linkBlock(T)
  }, reality.dest)))));
}

/* ─────────── ErrorTimeout pane (Etap 1) ─────────── */
function ErrorTimeoutPane({
  T,
  L,
  onRetry,
  onBack,
  ...
  }, L.server_down), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: T.ink3,
      lineHeight: 1.45,
  ...
  }, "\u041F\u043E\u0432\u0442\u043E\u0440\u043D\u0430\u044F \u043F\u043E\u043F\u044B\u0442\u043A\u0430 \u0447\u0435\u0440\u0435\u0437 ", secs, "s"), /*#__PURE__*/React.createElement("button", {
    onClick: onRetry,
    style: {
      ...btn(T, "ok"),
      padding: "0 24px"
...
function EmptyState({
  ...
  }, sub), actionLabel && onAction && /*#__PURE__*/React.createElement("button", {
    onClick: onAction,
    style: {
      ...btn(T, "ok"),
      padding: "0 22px"
...
function NotificationsScreen({
  ...
  const [busy, setBusy] = useState(false);
  useEffect(() => {
    rpc("notifications.get", {}).then(r => setPrefs(r.prefs || {})).catch(e => {
      if (e.code === 401) setErr(e);else {
        setPrefs({});
        toast(L.err + e.message, "err");
      }
  ...
  const row = (k, label, sub) => /*#__PURE__*/React.createElement("div", {
    onClick: () => toggle(k),
    style: {
      display: "flex",
      alignItems: "center",
  ...
  if (!prefs) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/"),
    themePref: themePref,
  ...
  }, row("tunnel_url_changed", L.tunnel_changed, L.cf_new_addr), row("client_added", L.client_added, L.new_key_made), row("traffic_limit_reached", L.limit_hit, L.quota_used), row("mode_switched", L.mode_switched, L.lite_pro_done), row("daemon_restart", L.daemon_restart, L.daemons_restarted))));
}

/* ─────────── PANEL ACCESS (Etap 3) ─────────── */
function PanelAccessScreen({
  T,
  L,
  themePref,
  onThemeClick,
  ...
  const [busy, setBusy] = useState(false);
  const load = () => rpc("panel.access_get", {}).then(setInfo).catch(e => {
    if (e.code === 401) setErr(e);else {
      setInfo({});
      toast(L.err + e.message, "err");
    }
  ...
  const onRotate = async () => {
    ...
    try {
      await rpc("panel.creds_rotate", {});
      toast(L.creds_updated, "ok");
      load();
    } catch (e) {
      if (e.code === 412 && e.detail && e.detail.confirm) {
  ...
  if (!info) return /*#__PURE__*/React.createElement(LoadingPane, {
    T: T,
    L: L,
    onBack: () => navigate("#/system"),
    themePref: themePref,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "3X-UI"), info.url && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      marginBottom: 4
    }
  }, L.panel_url), /*#__PURE__*/React.createElement("div", {
    onClick: () => onCopy(info.url),
    style: linkBlock(T)
  }, info.url)), info.username && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      margin: "10px 0 4px"
    }
  }, L.login), /*#__PURE__*/React.createElement("div", {
    onClick: () => onCopy(info.username),
    style: linkBlock(T)
  }, info.username)), info.password && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: T.ink3,
      margin: "10px 0 4px",
  ...
  }, /*#__PURE__*/React.createElement("span", null, L.password), /*#__PURE__*/React.createElement("button", {
  ...
  }, showPw ? L.hide : L.show)), /*#__PURE__*/React.createElement("div", {
    onClick: () => {
      if (showPw) onCopy(info.password);
    },
    style: {
      ...linkBlock(T),
      filter: showPw ? "none" : "blur(5px)",
      cursor: showPw ? "copy" : "default"
    }
  }, info.password)), info.mode && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10
    }
  }, /*#__PURE__*/React.createElement(Pill, {
    T: T,
    kind: "ok"
  }, info.mode === "ssh-only" ? "SSH-only" : L.public)), /*#__PURE__*/React.createElement("button", {
    onClick: onRotate,
    disabled: busy,
    style: {
      ...btn(T, "warn"),
...
function App() {
  ...
  const onThemeClick = () => {
    ...
    const names = {
      system: L.theme_sys_lc,
      light: L.theme_light_lc,
      dark: L.theme_dark_lc
    };
  ...
  if (hash === "#/" || hash === "" || hash === "#") {
    ...
    screen = /*#__PURE__*/React.createElement(ClientCardScreen, {
      T: T,
      L: L,
      uuid: uuid,
      themePref: pref,
    ...
    screen = /*#__PURE__*/React.createElement(ClientsListScreen, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(SystemScreenReal, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(AdminsScreenReal, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(InboundDetailScreen, {
      T: T,
      L: L,
      id: id,
      themePref: pref,
    ...
    screen = /*#__PURE__*/React.createElement(InboundsScreenReal, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(BackupScreenReal, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(RepairScreen, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(PanelAccessScreen, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(SettingsScreen, {
      ...
      onLangChange: lng => {
        try {
          localStorage.setItem("gov_lang", lng);
        } catch (e) {}
        window.location.reload();
      }
    });
  } else if (hash.startsWith("#/about")) {
    screen = /*#__PURE__*/React.createElement(AboutScreenReal, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
    ...
    screen = /*#__PURE__*/React.createElement(DisclaimerScreenReal, {
      T: T,
      L: L,
      themePref: pref,
      onThemeClick: onThemeClick,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, screen, /*#__PURE__*/React.createElement(ToastHost, null), /*#__PURE__*/React.createElement(ModalHost, null), /*#__PURE__*/React.createElement("style", null, `
